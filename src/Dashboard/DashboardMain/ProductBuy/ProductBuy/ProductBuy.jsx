...
const ProductBuy = () => {
  return (
    ...
    <div className="grid grid-cols-4 gap-4 mb-4">
      ...
      <input type="text" className="input input-bordered w-full" placeholder="মেমো# 00-0000" />
    ...
    <div className="flex justify-between items-center mb-4">
      ...
      <button className="btn btn-outline btn-primary ml-4">মেমো তালিকা</button>
    </div>
    ...
    <div className="grid grid-cols-5 gap-4 mb-4">
      ...
      <input type="text" className="input input-bordered" placeholder="কমিশন" />
      <input type="text" className="input input-bordered" placeholder="পরিবহন" />
    </div>

    <div className="flex justify-end">
      <button className="btn btn-success mr-2">সেভ</button>
      <button className="btn btn-outline">রিসেট</button>
    </div>
  </div>
  );
};
